...
public class Decode_Audio extends javax.swing.JFrame {
        ...
        jButtonDecode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(Decode_Audio.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButtonDecodeActionPerformed(java.awt.event.ActionEvent evt) throws IOException, UnsupportedAudioFileException {//GEN-FIRST:event_jButtonDecodeActionPerformed
