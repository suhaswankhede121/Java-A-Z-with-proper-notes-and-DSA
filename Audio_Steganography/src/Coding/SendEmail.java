...
public class SendEmail extends javax.swing.JFrame {
   ...
   if(open && fc.showOpenDialog(this) == fc.APPROVE_OPTION)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        jPasswordFrom.setText("Wankhede@99"); // Enter Your GmailApp Password
        jTextFrom.setText("suhaswankhede121@gmail.com"); // Enter your gmail
    ...
    // Get the Session object and pass it an Authenticator object
    ...
    try {
        ...
        // Create the message body and attachment parts
        Multipart multipart = new MimeMultipart();
        MimeBodyPart attachmentPart = new MimeBodyPart();
        MimeBodyPart textPart = new MimeBodyPart();

        // Attach the attachment file, if it exists
        File f = new File(jLabelAttachPath.getText());
        if (f.exists()) {
            attachmentPart.attachFile(f);
            multipart.addBodyPart(attachmentPart);
        } else {
            JOptionPane.showMessageDialog(null, "Attachment file not found!");
            return false;
        }

        // Set the message body, if it's not empty
        String messageText = jTextAreaBody.getText().trim();
        ...
        JOptionPane.showMessageDialog(null, "Error sending email: " + mex.getMessage());
        return false;
    } catch (IOException ioe) {
        JOptionPane.showMessageDialog(null, "Error attaching file: " + ioe.getMessage());
        return false;
    } catch (Exception e) {
